    ...
    public function run(): void
    {
        $pegawais = [
            ...
            [
                ...
                'nama_skpd' => 'Kecamatan Banjarmasin Tengah',
                'telp' => '081234567802',
            ],
        ];

        foreach ($pegawais as $data) {
            // Find skpd by nama_skpd
            $skpd = Skpd::where('nama_skpd', $data['nama_skpd'])->first();
            ...
            // Create pegawai dengan user_id dan skpd_id
            Pegawai::create([
                'nip' => $data['nip'],
                'nama' => $data['nama'],
                'skpd_id' => $skpd ? $skpd->id : null,
                'telp' => $data['telp'],
                'user_id' => $user->id,
            ]);
        }
