...
@section('title', 'Edit Pegawai - SKPD')
@section('header_title', 'Edit Pegawai')
@section('header_subtitle', 'Edit data pegawai')
...
<div class="mx-auto space-y-6 lg:space-y-8">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h3 class="font-heading font-bold text-2xl text-text">Edit Pegawai</h3>
            <p class="text-text-muted text-sm mt-1">Edit data pegawai</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-2xl shadow-card p-6 lg:p-8">
        <form action="{{ route('skpd.pegawai.update', $pegawai) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="nip" name="nip" value="{{ old('nip', $pegawai->nip) }}" required
            ...
            <div>
                ...
                <input type="text" id="telp" name="telp" value="{{ old('telp', $pegawai->telp) }}"
