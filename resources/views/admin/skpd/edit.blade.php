...
@section('header_subtitle', 'Perbarui data SKPD')
...
<div class="animate-fade-in max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-card overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-lg font-heading font-bold text-text">Form Edit SKPD</h2>
            <p class="text-sm text-text-muted mt-1">Perbarui data SKPD di bawah ini</p>
        </div>

        <form action="{{ route('admin.skpd.update', $skpd->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="kode_skpd" 
                           name="kode_skpd" 
                           value="{{ old('kode_skpd', $skpd->kode_skpd) }}"
