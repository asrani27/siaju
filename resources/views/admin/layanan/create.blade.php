...
@section('header_subtitle', 'Tambah data layanan baru')
...
<div class="animate-fade-in max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-card overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-lg font-heading font-bold text-text">Form Tambah Layanan</h2>
            <p class="text-sm text-text-muted mt-1">Lengkapi form di bawah untuk menambahkan data layanan</p>
        </div>

        <form action="{{ route('admin.layanan.store') }}" method="POST" class="p-6">
            @csrf
                ...
                <div class="relative flex items-start">
                    <div class="flex items-center h-5">
                        <input id="is_active" 
                               ...
                               value="1"
                               checked
                               class="w-5 h-5 text-primary bg-white border-gray-300 rounded focus:ring-primary cursor-pointer">
                    </div>
                    <div class="ml-3 text-sm cursor-pointer" onclick="document.getElementById('is_active').click()">
